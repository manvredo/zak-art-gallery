...
const translations = {
  en: {
    ...
    shop: {
      ...
      inquire: 'Enquire',
      inquiryMessage: 'Hello Mr Zak,\n\nI am interested in the painting "{name}" ({size}). Could you tell me the price and shipping options?\n\n',
    ...
    newsletter: {
      ...
      rateLimited: 'A confirmation email was already sent recently. Please check your inbox or try again in a few minutes.',
    ...
    footerExtension: {
      ...
      paymentDescription: 'All payments are processed securely through Stripe, a leading provider of encrypted payment infrastructure. Depending on your preference, you can pay by credit card, Apple Pay, PayPal, or Klarna — all handled within Stripe\'s secure checkout.',
      shippingDescription: 'We ship within Germany via DHL and Hermes, and internationally via UPS — every artwork carefully packaged and fully insured up to €10,000. Delivery takes 2-3 business days domestically. Free shipping on orders over €500.',
      returnLabel: 'Return Label',
      returnLabelText: '30 days to return an artwork, free of charge — just request your prepaid return label.',
      safe: 'Safe',
      ssl: 'SSL',
  ...
  de: {
    ...
    shop: {
      ...
      buyOn: 'Kaufen bei {platform}',
      priceOnRequest: 'Preis auf Anfrage',
      inquire: 'Anfrage stellen',
      inquiryMessage: 'Hallo Herr Zak,\n\nich interessiere mich für das Bild „{name}“ ({size}). Können Sie mir Preis und Versandmöglichkeiten nennen?\n\n',
    ...
    newsletter: {
      ...
      success: 'Willkommen! Prüfen Sie Ihr Postfach.',
      alreadySubscribed: 'Sie sind bereits angemeldet!',
      error: 'Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.',
      networkError: 'Netzwerkfehler. Bitte versuchen Sie es erneut.',
      rateLimited: 'Es wurde bereits kürzlich eine Bestätigungsmail verschickt. Bitte prüfen Sie Ihr Postfach oder versuchen Sie es in ein paar Minuten erneut.',
    ...
    footerExtension: {
      ...
      contact: 'Kontakt',
      faq: 'Häufige Fragen',
      paymentDescription: 'Alle Zahlungen werden sicher über Stripe abgewickelt, einen führenden Anbieter für verschlüsselte Zahlungsinfrastruktur. Je nach Wunsch kannst du per Kreditkarte, Apple Pay, PayPal oder Klarna bezahlen — alles innerhalb der sicheren Stripe-Checkout-Umgebung.',
      shippingDescription: 'Innerhalb Deutschlands versenden wir mit DHL und Hermes, international mit UPS — jedes Kunstwerk sorgfältig verpackt und bis €10.000 versichert. Die Lieferzeit beträgt 2-3 Werktage innerhalb Deutschlands. Kostenloser Versand ab €500.',
      returnLabel: 'Retourenlabel',
      returnLabelText: '30 Tage Zeit für die Rückgabe eines Kunstwerks, kostenfrei — fordere einfach dein vorfrankiertes Retourenlabel an.',
      safe: 'Sicher',
      ssl: 'SSL',
