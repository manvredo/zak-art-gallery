...
function UnsubscribedContent() {
  ...
  const copyByStatus = {
    success: { title: t.newsletter.unsubscribedTitle, message: t.newsletter.unsubscribedMessage },
    invalid: { title: t.newsletter.unsubscribedInvalidTitle, message: t.newsletter.unsubscribedInvalidMessage },
