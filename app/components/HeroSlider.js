...
export default function HeroSlider() {
  ...
  return (
    <div className="relative w-full aspect-[21/9] md:aspect-[21/9] max-h-[600px] overflow-hidden rounded-lg">
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative h-full flex flex-col items-center justify-center text-center px-4 z-20">
            ...
            <p 
              className={`text-lg md:text-xl text-white mb-8 max-w-3xl transition-all duration-700 ${
                index === currentSlide 
                  ? 'translate-y-0 opacity-100' 
                  : 'translate-y-8 opacity-0'
              }`}
            ...
            <Link
              ...
              className={`px-8 py-3 bg-white text-gray-900 hover:bg-gray-100 transition-all duration-700 rounded font-medium text-lg ${
                index === currentSlide 
                  ? 'translate-y-0 opacity-100' 
                  : 'translate-y-8 opacity-0'
              }`}
