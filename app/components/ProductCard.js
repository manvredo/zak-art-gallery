...
export default function ProductCard({ product, onClick, showAddToCart = false, index = 0 }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden rounded-xl mb-3 group-hover:shadow-[0_4px_12px_rgba(0,0,0,0.25)] group-hover:translate-y-1 transition-shadow duration-200">
        <img
          src={product.image}
          alt={product.name}
