            ...
            <nav className="hidden lg:flex items-center space-x-8 ml-24">
              ...
              >
                <span className="relative inline-block">
                  {t.nav.welcome}
                  <span className="absolute -bottom-0.5 left-0 w-0 h-[2px] bg-current transition-all duration-300 ease-in-out group-hover:w-full" />
                </span>
              </Link>
              <Link
                href="/about"
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <span className="relative inline-block">
                ...
                <span className="absolute -bottom-1 left-0 w-0 h-[2px] bg-current transition-all duration-300 ease-in-out group-hover:w-full" />
              </span>
              {cartItemCount > 0 && (
